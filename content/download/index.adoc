...
| https://downloads.apache.org/hop/2.12.0/apache-hop-2.13.0-src.tar.gz.asc[asc] 
| https://downloads.apache.org/hop/2.12.0/apache-hop-2.13.0-src.tar.gz.sha512[sha512]
