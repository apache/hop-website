...
Apache Hop requires Java 21 to be installed on the system. Check https://hop.apache.org/manual/latest/supported-jvms.html[the docs^] for more information about the supported JVMs. 
