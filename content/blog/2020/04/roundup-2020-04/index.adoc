...
We do have a great link:/manual/latest/getting-started/index.html[getting started] but our link:/manual/latest/index.html[user manual] is currently falling a bit short.
