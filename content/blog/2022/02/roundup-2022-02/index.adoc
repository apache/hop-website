...
A couple of notable new contributions are SonarCube code cleanup and fixes, Brazilian Portuguese translations and a new link:/manual/0/how-to-guides/apache-hop-web-services-docker.html[Hop web services in Docker tutorial]. A huge thank you to everyone who contributed!
