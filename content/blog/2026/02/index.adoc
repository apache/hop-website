...
date: 2026-02-01T06:44:56+02:00
...
Explore the https://github.com/apache/hop/milestone/18?closed=1[Apache Hop 2.17 Milestone] and the https://github.com/apache/hop/releases/tag/2.16.0-rc1[Release notes^] on GitHub.
