...
image:/img/Release-1.0/unit-tests.png[Hop unit tests, align="left", width="90%", link="image:/img/Release-1.0/unit-tests.png"]

image:/img/Release-1.0/unit-tests-logging.png[Hop unit tests logging output, align="left", width="90%", link="image:/img/Release-1.0/unit-tests-logging.png"]
