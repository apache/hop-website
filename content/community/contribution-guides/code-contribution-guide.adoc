...
Create a https://issues.apache.org/jira/projects/HOP/issues[Jira] ticket or mailing list discussion and reach consensus
...
In most cases, the discussion should happen in Hop’s bug tracker: https://issues.apache.org/jira/projects/HOP/issues[Jira].
