...
export const events = [
  { date: "2026-10-27", name: "Webinar Enterprise-Datenintegration mit Apache Hop: Stand und Praxisbericht 2026-09", lang: "DE", description: "Webinar (online, kostenlos, 11:00-12:00 Uhr, Moderation: Stefan Keller, OST) zum Stand der Enterprise-Datenintegration mit Apache Hop: Neues zu den GIS-Plugins, zwei Praxisberichte der Glue Software Engineering AG (Web-Harvesting, Shared Mobility) und ein Ausblick auf Apache Hop und KI-Tools. Wird nicht aufgezeichnet.", link: { label: "Info & registration", href: "https://www.giswiki.ch/Webinar_Apache_Hop_GIS_2026-09" } },
  { date: "2026-10-08", name: "Découvrez comment automatiser et fiabiliser vos données sans dépendre d'une solution propriétaire", lang: "FR", description: "Vos traitements de données sont devenus trop complexes? Découvrez comment les automatiser et les fiabiliser sans dépendre d'une solution propriétaire. Entre multiplication des sources, besoin de fiabilité et exigences de suivi, les organisations cherchent des solutions plus claires, ouvertes et faciles à faire évoluer.", link: { label: "S'inscrire", href: "https://webikeo.fr/webinar/decouvrez-comment-automatiser-et-fiabiliser-vos-donnees-sans-dependre-d-une-solution-proprietaire" }},
