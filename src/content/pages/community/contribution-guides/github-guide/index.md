...
1. [Creating a GitHub Issue](#create-ticket)
2. [Ticket priorities](#ticket-priority)
3. [Hop GitHub Issues Workflow](#workflow)
4. [Hop GitHub Actions](#github-actions)

<a id="create-ticket"></a>
...
These criteria are only applicable when we are talking about bugs or small changes to the code. When you have a great new idea or major change for the product please start a discussion on our dev chat channel first, for more info on this please take a look at our [Code Contribution Guide](../code-contribution-guide/).
