...
publishDate: "2023-12-01T09:49:56+02:00"
authors: hansva
...
![ width="45](/img/Release-2.7/hop-27.svg)


or [***download Hop 2.7.0 ***](https://hop.apache.org/download/) right away.
...
![Redshift bulk loader transform](/img/Release-2.7/redshift-bulkloader.png)
...
![Redshift bulk loader transform underlined](/img/Release-2.7/redshift-bulkloader-underline.png)
...
If you wish to help translate Hop to your local language visit our [translation website](https://translate.project-hop.org/). If you would like to add support for an additional language, please create a ticket and we will set up the translation service.
...
* chat: 670 registered members (up from 641) [join](https://chat.project-hop.org)
* LinkedIn: 1.509 followers (up from 1.445) [follow](https://www.linkedin.com/company/hop-project)
* Twitter/X: 904 followers (down from 906) [follow](https://twitter.com/ApacheHop)
* YouTube: 939 subscribers (up from 892) [subscribe](https://www.youtube.com/ApacheHop)
* 3Hx Meetup: 279 members (stable)  [join](https://www.meetup.com/3hx-apache-hop-incubating-hot-hop-hangouts/)

![Apache Hop Community Growth](/img/Release-2.7/hop-community-growth.png)
...
Check out the full list of issues in Apache Hop 2.7.0 in our [Github Issues](https://github.com/apache/hop/issues) 
and the [Release notes](https://github.com/apache/hop/releases/tag/2.7.0-rc1).
