...
publishDate: "2024-12-09T06:44:56+02:00"
authors: bamaer
...
![ width="45](/img/Release-2.11/hop-211.svg)


or [***download Hop 2.11.0 ***](https://hop.apache.org/download/) right away.

Apache Hop 2.11.0 comes with a lot of bug fixes, code hardening and a couple of new features. 

## 4 NLP and LLM transforms 

[Tristan Everitt](https://github.com/ep9io) made a major contribution to Apache Hop, with no less than new 4 transforms. Thanks a lot, Tristan! 
...
![LLM and NLP transforms](/img/Release-2.11/llm-nlp-transforms.png)
...
![File Explorer](/img/Release-2.11/file-explorer.png)
...
![Syntax Highlighting](/img/Release-2.11/syntax-highlighting.png)
...
> [!WARNING]
> The Apache Hop community will move away from Mattermost after 2024. As of January 1st, 2025, the Mattermost chat will be replaced by [GitHub discussions](https://github.com/apache/hop/discussions/) and the ASF Slack `#hop` channel.  Check [our recent post](/blog/2024/10/moving-away-from-mattermost/) for more details.

The Hop community continues to grow!

The overview below shows the community growth compared to the 2.10.0 release in October:

* chat: 886 registered members (up from 867) [join](https://chat.project-hop.org)
* LinkedIn: 2.545 followers (up from 2.262) [follow](https://www.linkedin.com/company/hop-project)
* Twitter/X: 949 followers (unchanged from 949) [follow](https://twitter.com/ApacheHop)
* YouTube: 1.280 subscribers (up from 1.220) [subscribe](https://www.youtube.com/ApacheHop)

![Apache Hop Community Growth](/img/Release-2.11/hop-community-growth.png)
...
* [Adalennis](https://github.com/Adalennis)
* [Tristan Everitt](https://github.com/ep9io)
* [Muralidharan Deenathayalan](https://github.com/muralidharand)
* [Tim Eckley](https://github.com/wAVeckx)

Check out the full list of issues in Apache Hop 2.11.0 in our [Github Issues](https://github.com/apache/hop/issues) 
and the [Release notes](https://github.com/apache/hop/releases/tag/2.11.0-rc1).
