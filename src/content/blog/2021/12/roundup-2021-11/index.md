...
publishDate: "2021-12-02T07:59:56+02:00"
authors: bamaer
...
![Hop Server Status Transform](/img/Roundup-2021-12/hop-transform-server-status.png)
...
We created a separate branch with its own [daily build](https://ci-builds.apache.org/job/Hop/job/Hop/job/2.0.0/) to start working towards Hop 2.0 on Java 11.
...
* 3H12 - a well-designed Hop project walkthrough (2021-10-28, [recording](https://www.youtube.com/watch?v=a1jg1A2vmtA))
* 3H13 - Apache Hop sucks! Let’s un-suck it (2021-11-18, [recording](https://www.youtube.com/watch?v=qW5Jwe5OipU))

Check the [events](/community/events/) page for the full 3Hx schedule.

### Hop Community

The Hop community continues to grow:

* chat: 243 registered members (up from 217) [join](https://chat.project-hop.org)
* LinkedIn: 690 followers (up from 603) [follow](https://www.linkedin.com/company/hop-project)
* Twitter: 545 followers (up from 488) [follow](https://twitter.com/ApacheHop)
* YouTube: 325 subscribers (up from 247) [subscribe](https://www.youtube.com/channel/UCGlcYslwe03Y2zbZ1W6DAGA)
* Meetup: 211 members (up from 168) link: [join](https://www.meetup.com/3hx-apache-hop-incubating-hot-hop-hangouts)
