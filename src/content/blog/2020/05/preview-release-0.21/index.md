...
publishDate: "2020-05-07T12:01:56+02:00"
...
***Direct download [here](https://artifactory.project-hop.org/artifactory/hop-releases-local/org/hop/hop-assemblies-client/0.21/hop-assemblies-client-0.21.zip)***

***[Getting Started Guide](/manual/latest/getting-started/)***

Release Notes: ***[0.20](https://project-hop.atlassian.net/secure/ReleaseNote.jspa?projectId=10002&version=10001)****, **[0.21](https://project-hop.atlassian.net/secure/ReleaseNote.jspa?projectId=10002&version=10004)*** (one last-minute fix)
...
Hop’s tools reflect its Architecture, check out the [Concepts](/manual/latest/concepts.html) page.
...
[![Interface 1 ](/img/Roundup-2020-04/roundup-2020-04-0001.png)](/img/Roundup-2020-04/roundup-2020-04-0001.png)
...
[![Interface 2 ](/img/Roundup-2020-04/roundup-2020-04-0003.png)](/img/Roundup-2020-04/roundup-2020-04-0003.png)
...
We do have a great [getting started](/manual/latest/getting-started/) but our [user manual](/manual/latest/) is currently falling a bit short.
