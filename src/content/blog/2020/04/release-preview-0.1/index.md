...
publishDate: "2020-04-09T12:01:56+02:00"
authors: hansva
...
Please take it for a spin. If you find a bug, please create a [bug ticket](https://jira.project-hop.org), if there’s functionality you’d like to see, please create a [feature request](https://jira.project-hop.org).

***Direct download [here](https://artifactory.project-hop.org/artifactory/hop-releases/org/hop/hop-assemblies-client/0.10/hop-assemblies-client-0.10.zip)***

***[Getting Started Guide](http://www.project-hop.org/docs/getting-started/)***

***[Release Notes](https://project-hop.atlassian.net/secure/ReleaseNote.jspa?projectId=10002&version=10000)***
...
Hop’s tools reflect its Architecture, check out the [Concepts](http://www.project-hop.org/manual/latest/concepts.html) page.
...
[![Interface 1 ](/img/Roundup-2020-03/roundup-2020-03-0001.png)](/img/Roundup-2020-03/roundup-2020-03-0001.png)

The Transform chooser dialog:

[![Interface 1](/img/Roundup-2020-02/roundup-2020-02-0001.png)](/img/Roundup-2020-02/roundup-2020-02-0001.png)

Partitioning:

[![Partitioning ](/img/Roundup-2020-03/roundup-2020-03-0002.png)](/img/Roundup-2020-03/roundup-2020-03-0002.png)

Extra options on transform action:

[![Transform action ](/img/Roundup-2020-03/roundup-2020-03-0003.png)](/img/Roundup-2020-03/roundup-2020-03-0003.png)
...
Check the [Translation Contribution Guide](http://www.project-hop.org/community/contribution-guides/translation-contribution-guide/) to add or improve the Hop translation for your own native language.
...
[![Translator ](/img/Roundup-2020-03/roundup-2020-03-0004.png)](/img/Roundup-2020-03/roundup-2020-03-0004.png)
...
All documentation is written in asciidoc and is treated just like any other piece of code, so feel free to create [bug tickets](https://jira.project-hop.org) or [feature request](https://jira.project-hop.org) for documentation, just like you would for any other part of the project.
...
* testing and creating [bug tickets](https://jira.project-hop.org)
* create [feature requests](https://jira.project-hop.org)
* write documentation
* spreading the word

Check out the [Contribution Guide](http://www.project-hop.org/community/contributing/) to find out how you can contribute.
