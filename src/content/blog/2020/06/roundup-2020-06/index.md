...
publishDate: "2020-06-27T12:01:56+02:00"
authors: bamaer
...
A lot of work has been done in the last couple of weeks. A huge thanks to [Matt](https://twitter.com/mattcasters), who implemented most of the functionality that was added this month.
...
[![Hop Config](/img/Roundup-2020-06/hop-config.png)](/img/Roundup-2020-06/hop-config.png)
...
[![Hop File Dialog](/img/Roundup-2020-06/hop-file-dialog.png)](/img/Roundup-2020-06/hop-file-dialog.png)
...
This is a first but functional implementation, based on the SpoonGit plugin originally written by [Hiromu Hota](https://twitter.com/HiromuHota)

[![Hop Git](/img/Roundup-2020-06/hop-git.png)](/img/Roundup-2020-06/hop-git.png)

## WebHop

WebHop is another area that has seen a lot of progress in the last month. The code was moved from [Hiromu](https://twitter.com/HiromuHota)'s fork to a separate [web](https://github.com/project-hop/hop/tree/web) branch in the Hop repository.
...
[![Hop Web](/img/Roundup-2020-06/hop-web.png)](/img/Roundup-2020-06/hop-web.png)
...
[![Hop Search](/img/Roundup-2020-06/hop-ctrl-f.png)](/img/Roundup-2020-06/hop-ctrl-f.png)
...
[![Hop Preview](/img/Roundup-2020-06/hop-preview.png)](/img/Roundup-2020-06/hop-preview.png)

The preview (number of rows, none, first, last, random) can be configured in the local run configuration.

[![Hop Preview Config](/img/Roundup-2020-06/hop-preview-config.png)](/img/Roundup-2020-06/hop-preview-config.png)
...
Feel free to take a look at the documentation we currently have, and [reach out](https://chat.project-hop.org/) if you’d like to contribute documentation.
We consider any error or incorrect information in the documentation to be a bug. Please create a [ticket](https://jira.project-hop.org) if you run into an issue.

[Brandon](https://twitter.com/usbrandon) contributed a first video on how to download, install and run Hop on Windows to our [YouTube channel](https://www.youtube.com/channel/UCGlcYslwe03Y2zbZ1W6DAGA). Thanks a lot, Brandon!
