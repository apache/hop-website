...
publishDate: "2020-03-31T12:01:56+02:00"
authors: hansva
...
We have continued to walk the path of major code cleanup and refactoring. Because we don’t want to bore you with the technical stuff (those interested in the technical stuff come and ask in our [#dev channel](https://chat.project-hop.org) ) here is an overview of what you can see.
...
This program requires a local clone of the hop project, and will show you what has been translated and what is on the to-do list. Instructions on how to use the translator can be found in the [Translation Contribution Guide](/community/contribution-guides/translation-contribution-guide/)
