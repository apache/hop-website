...
Check the [0.30 summary](/blog/2020/07/preview-release-0.30/) to find out what was include in the release.
...
* [Hop Gui](/manual/latest/hop-gui/index.html): the process of creating, running and debugging workflows and pipelines, each with their run configurations
* [Kettle -> Hop](/manual/next/hop-vs-kettle/hop-vs-kettle.html): a comparison between Kettle/PDI and Hop to make transitioning from Kettle/PDI to Hop easier
...
As always, ping us on [mattermost](https://chat.project-hop.org) to discuss documentation, and create [tickets](https://jira.project-hop.org) if you find any missing or incorrect information in the docs. Documentation is code, we take bugs in the documentation just as serious as bugs in the code.
...
![Metadata Injection](/img/Roundup-2020-08/metadata-injection.png)
...
Check the [plugin porting guide](/dev-manual/latest/porting-kettle-plugins.html) to find out how you can port plugins yourself.
...
Check out the recording of the talk [here](https://www.crowdcast.io/e/beamsummit/26).

![Beam Summit](/img/Roundup-2020-08/beam-summit.jpeg)

## Future

Our main focus for the coming weeks is on bug hunting and documentation!

In the meantime, we’re getting really close to start the ASF incubation process, and hope to see Apache Hop as a podling in the [ASF Incubator list](https://incubator.apache.org/) really soon.

While building Project Hop up to the point where we are now and with the valueable feedback we’ve received from the community, we’ll update the [roadmap](/docs/roadmap/) with plans for future releases.
