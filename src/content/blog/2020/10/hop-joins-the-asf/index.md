...
From the very start with Hop, we haven’t exactly been secretive about our intention to join the [Apache Software Foundation (ASF)](https://apache.org) and donate Project Hop to the ASF as Apache Hop.

After almost a year of work on Project Hop, we’re very happy to announce we’ve reached a first milestone: the Apache Hop [proposal](https://cwiki.apache.org/confluence/display/INCUBATOR/HopProposal) was [submitted](https://mail-archives.apache.org/mod_mbox/incubator-general/202009.mbox/browser) to the incubator mailing list on September, 9th and has been accepted!
...
[![Apache Software Foundation](/img/asf_logo_wide.png)](/img/asf_logo_wide.png)]

### Why Apache Hop, what will happen to Project Hop?

By donating Project Hop to the ASF, we’ll guarantee that no individual or organization has full control over the software and make sure Hop will remain free ([as in speech](https://en.wikipedia.org/wiki/Gratis_versus_libre#%22Free_beer%22_vs_%22freedom_of_speech%22_distinction)) forever.
...
In the meantime, keep an eye on [hop.apache.org](https://hop.apache.org) ;-)
...
* ***champion***: our champion is [Maximilian Michels](https://twitter.com/stadtlegende), who has successfully guided Apache Flink and Apache Beam through the incubation process.
* mentors: [Julian Hyde](https://twitter.com/julianhyde), [Tom Barber](https://twitter.com/magicaltrout), [Kevin Ratnasekera](https://github.com/djkevincr) and [François Papon](https://twitter.com/fpapon2).
...
From [Wikipedia](https://en.wikipedia.org/wiki/The_Apache_Software_Foundation):
