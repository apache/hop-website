...
publishDate: "2025-08-20T06:44:56+02:00"
authors: bamaer
...
![ width="45](/img/Release-2.15/hop-215.svg)


or [***download Hop 2.15.0 ***](https://hop.apache.org/download/) right away.
...
![Google Sheets Output Re-create Sheet Option](/img/Release-2.15/google-sheets-output-recreate-sheet.png)
...
![Databricks Dialect](/img/Release-2.15/databricks-dialect.png)
...
…and many other minor fixes and improvements. See the [full changelog](https://github.com/apache/hop/milestone/16?closed=1).

## The Apache Hop Community is growing stronger

Our community continues to grow steadily:

* LinkedIn: 3,409 followers (up from 3,130) [follow](https://www.linkedin.com/company/apache-hop/)
* Twitter/X: 981 followers (up from 976) [follow](https://twitter.com/ApacheHop)
* YouTube: 1,460 subscribers (up from 1,400) [subscribe](https://www.youtube.com/c/ApacheHop)
...
[Download 2.15 now](https://hop.apache.org/download/) and experience the improved stability, usability, and new features firsthand.

Want to see every single fix and enhancement?  
Explore the [Apache Hop 2.15 Milestone](https://github.com/apache/hop/milestone/35?closed=1) on GitHub.
...
Check out the full list of issues in Apache Hop 2.15.0 in our [Github Issues](https://github.com/apache/hop/issues) 
and the [Release notes](https://github.com/apache/hop/releases/tag/2.15.0-rc2).
